...
export default function Home() {
  return (
    <main className="min-h-screen bg-white flex flex-col justify-center px-4 lg:px-16">
      <section className="text-center lg:text-left bg-white">
        ...
        <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl md:text-xl">
          Discover exciting job opportunities across various industries. Your
